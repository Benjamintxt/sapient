...
Future<void> showDeleteSubjectDialog({
  ...
  logDeleteSubject("🗑️ Demande suppression : $subjectName (ID=$subjectId)");

  // 🧱 Affiche la boîte de dialogue
  await showDialog(
    context: context, // 📍 Contexte nécessaire à l'affichage de la boîte
    builder: (_) => AlertDialog(
      title: Text(AppLocalizations.of(context)!.delete_subject), // 🏷️ Titre de la boîte (traduit)
