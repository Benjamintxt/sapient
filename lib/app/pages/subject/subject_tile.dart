...
import 'package:sapient/app/pages/subject/subject_page.dart'; //  Page de sous-sujets
...
class SubjectTile extends StatelessWidget {
  ...
  final String subjectName; // 🏷 Nom du sujet affiché
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: Padding(
        padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8), // ️️ Espace autour du container
        ...
        child: Container(
          ...
          child: ListTile(
            contentPadding: const EdgeInsets.symmetric(horizontal: 20, vertical: 12), // ️ Marge interne
            ...
            trailing: const Icon(Icons.chevron_right, color: Color(0xFF4A148C)), // ️ Icône de flèche
              ...
              onTap: () {
                ...
                logTile(" Chemin mis à jour : $updatedPath");
