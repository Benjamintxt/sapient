...
class SubjectPage extends StatelessWidget {
  ...
  final String? title; // 🏷 Titre à afficher (nom du sujet parent)

  const SubjectPage({
    super.key, //  Clé widget
    this.level = 0, //  Niveau par défaut = racine
    this.parentPathIds, //  Liste des parents (peut être null pour racine)
    this.title, //  Titre facultatif (affiché en haut)
  });
  ...
  //  Arrière-plan floral pastel + couche blanche semi-transparente
