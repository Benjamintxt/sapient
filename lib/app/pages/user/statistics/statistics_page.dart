  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          local.statistics, // 🏷 Texte "Statistiques"
          style: const TextStyle(
            fontWeight: FontWeight.bold, //  Gras
            fontFamily: 'Raleway', //  Police élégante
        ...
        builder: (context, snapshot) {
          ...
          return Stack(
            children: [
              ...
              Positioned.fill(
                child: Image.asset(
                  'assets/images/Screen statistique.png', // 🖼 Fond pastel
                        ...
                        children: [
                          Expanded(
                            child: MiniStatCard(
                              ...
                              value: "$avgTimePerRevision sec", //  Durée à afficher
                          ...
                          Expanded(
                            child: MiniStatCard(
                              ...
                              value: "$avgTimePerFlashcard sec",         //  Durée à afficher
