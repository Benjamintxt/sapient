...
class FlashcardTile extends StatelessWidget {
  ...
  final String? imageFrontUrl; // URL image du recto (si présente)
  final String? imageBackUrl; // URL image du verso (non utilisé ici mais fourni pour la navigation)
  ...
  const FlashcardTile({
    super.key, // Clé Flutter (gestion widget identique)
        ...
        child: Container( // Boîte contenant la ListTile stylée
          ...
          child: ListTile( // Contenu structuré (titre + icône)
            ...
            frontText.trim().isNotEmpty // Si le texte du recto est non vide
              ...
              '[Flashcard vide]', // ️Indicateur carte vide
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.bold,
